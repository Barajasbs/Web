...
public class ConductorController {
    ...
    public ResponseEntity<Conductor> asignarBus(@PathVariable Long id, @RequestBody AsignacionBusDto asignacionDto) {
        Conductor conductorActualizado = conductorService.asignarBus(id, asignacionDto.getBusId(), asignacionDto.getDias());
